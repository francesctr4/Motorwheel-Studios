...
public:
	...
	Particle disk_straightRightThrow;
	Particle disk_upRightThrow;
	Particle disk_downRightThrow;

	Particle disk_straightLeftThrow;
	Particle disk_upLeftThrow;
	Particle disk_downLeftThrow;

	Particle lob;

	Particle supersonic;
	//Particle supersonic_upRightThrow;
	//Particle supersonic_downRightThrow;
